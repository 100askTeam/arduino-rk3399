...
{
	if (this->m_sPath == UART1_PATH)
		this->m_iFile = open(UART1_PATH, O_RDWR | O_NOCTTY | O_NDELAY);
	else if (this->m_sPath == UART2_PATH)
		this->m_iFile = open(UART2_PATH, O_RDWR | O_NOCTTY | O_NDELAY);
